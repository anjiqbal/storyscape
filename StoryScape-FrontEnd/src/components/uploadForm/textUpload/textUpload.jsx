    ...
    <>
      <div className="col-sm-4 well">
        <form acceptCharset="UTF-8" action="" method="POST">
          <textarea className="form-control" id="text" name="text" maxLength="200" placeholder="Please add a short description of your video" rows="5" value={text} onChange={handleChange}></textarea>
